...
echo.
FRAMEDELAY=3
echo Press enter for a demonstration on frame rate and gap leaving
pause >nul
exit /b
...
:Frame60
cls
echo As you can see that frame lasted longer, as
echo it was frame 40 and the next specified frame
echo was frame 60
SET FRAMEDELAY=2
echo.
echo.
...
:Frame80
cls
echo The Gap between the last frame and this frame was
echo also twenty frames big, but took less time as I decreased the FrameDelay
echo temporarily, you would do this to improve movement quality
echo during your movie.
echo.
echo.
